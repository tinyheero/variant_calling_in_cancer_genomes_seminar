---
title: "Variant Calling in Cancer Genomes Seminar"
...
```{r warning = FALSE}
strelkaDt <- 
  fread("strelka/HCC1395_exome_tumour_normal/results/passed.somatic.snvs.snpeff.tsv", 
        header = T)
...
```{r}
museqDt <- fread("museq/results/HCC1395_exome_tumour_normal.snpeff.tsv",
                 header = TRUE)
