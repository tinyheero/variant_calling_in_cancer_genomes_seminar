...
The corresponding presentation slides can also be found in this repository ([variant_calling_presentation.pdf](variant_calling_in_cancer_genomes_seminar/variant_calling_presentation.pdf))
